...
//评分
    ...
    //输入图片、种子、电影 电脑地址
    static HWND hBtnPhotoAddress;
    static HWND hEditPhotoAddress;
    static HWND hBtnTorrentAddress;
    static HWND hEditTorrentAddress;
    static HWND hBtnFileAddress;
    ...
    switch(message)
    {
        case WM_CREATE:
            ...
            hBtnPhotoAddress=CreateWindow(
                TEXT("button"),TEXT("输入图片地址:"),
                WS_CHILD | WS_VISIBLE | WS_BORDER | BS_CENTER | BS_VCENTER,
                90,585,150,40,
            ...
            //输入图片、种子、电影 电脑地址
            SendMessage(hBtnPhotoAddress,WM_SETFONT,(WPARAM)hFontTitle,NULL);
            SendMessage(hEditPhotoAddress,WM_SETFONT,(WPARAM)hFontTitle,NULL);
            SendMessage(hBtnTorrentAddress,WM_SETFONT,(WPARAM)hFontTitle,NULL);
            SendMessage(hEditTorrentAddress,WM_SETFONT,(WPARAM)hFontTitle,NULL);
            SendMessage(hBtnFileAddress,WM_SETFONT,(WPARAM)hFontTitle,NULL);
