        ...
        case WM_PAINT:
            ...
            switch (wParam)
            {
                ...
                case 36:
                    ...
                    GetWindowText(hEditPhotoAddress,szTextBuf,100);
                    if (vis_photo==true) strcpy(szTextBuf,"E:\\MovieSoftware\\Photo\\white.bmp");
                    hdc=GetDC(hWnd);
