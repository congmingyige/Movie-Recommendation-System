...
struct user
{
    ...
    int Sex,Age,Condition;
    //Preference:偏好(喜剧1、爱情2、动作3、动画4、青春5、悬疑6、科幻7、惊悚8、其它9、不填0)
    int Preference[10];
};
...
struct movie
{
    ...
    //Category:模式(喜剧1、爱情2、动作3、动画4、青春5、悬疑6、科幻7、惊悚8、其它9、不填0)
    //Mood:心情(高兴1、激动2、自豪3、伤心4、愤怒5、害怕6、羞愧7、忐忑8)
    //0不是 1是
