...
//初始化
    ...
    fileopen_movie();
    //新建 清空
    SendMessage(hwnd,WM_COMMAND,(WPARAM)48,NULL);//改
...
LRESULT CALLBACK WndProc(HWND hWnd,UINT message,WPARAM wParam,LPARAM lParam)
{
    ...
    static bool vis_edit=true,vis_page=true,vis_check=true;
    long i,page;
    //0:新建 1:修改
        ...
        case WM_COMMAND:
            ...
            switch (wmId)
            {
                ...
                case 47:
                    ...
                    GetWindowText(hEditPlace,movie[pos_movie].Country,100);
                    GetWindowText(hEditIntroduce,szPassage,1000);
                ...
                case 51://改
                    system("E:\\MovieSoftware\\movie.txt");
                    break;
