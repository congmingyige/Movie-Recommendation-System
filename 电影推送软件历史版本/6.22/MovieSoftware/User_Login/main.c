...
LRESULT CALLBACK WndProc(HWND hWnd,UINT message,WPARAM wParam,LPARAM lParam)
{
    ...
    static INT LoginMode=3;
    //矩形所在位置
    static INT PreviousRect,CurrentRect=1;
    //矩形顶点
    ...
    switch(message)
    {
        case WM_CREATE:
            ...
            hLabNewPassword=CreateWindow(
                TEXT("static"),TEXT(""),
                WS_CHILD | SS_CENTERIMAGE | SS_RIGHT | SS_CENTERIMAGE,
                70,130,70,26,
            ...
            SendMessage(hWnd,WM_PAINT,(WPARAM)LoginMode,NULL);
            break;
        ...
        case WM_COMMAND:
            ...
            switch(wmId)
            {
                ...
                case 100:
                    ...
                    GetWindowRect(hBtnLoginSubmit,&rect4);
                    switch(LoginMode)
                    {
                        case 1:
                            if (rect1.left<=p.x && rect1.right>=p.x && rect1.top<=p.y && rect1.bottom>=p.y)
                            {
                                ...
                                SetCursorPos((rect4.left+rect4.right)/2,(rect4.top+rect4.bottom)/2);
                            else
                            {
                        ...
                        case 3:
                            ...
                            else if (rect3.left<=p.x && rect3.right>=p.x && rect3.top<=p.y && rect3.bottom>=p.y)
                                SetCursorPos((rect4.left+rect4.right)/2,(rect4.top+rect4.bottom)/2);
                            else
                            {
                                SetCursorPos(rect1.left,rect1.top);
                ...
                case 7:
                    ...
                    CurrentRect=1;
                    //更新矩形
                    SendMessage(hWnd,WM_PAINT,(WPARAM)1,NULL);
                    //更改鼠标位置
                    SendMessage(hWnd,WM_COMMAND,(WPARAM)7,NULL);
                    break;
                //注册
