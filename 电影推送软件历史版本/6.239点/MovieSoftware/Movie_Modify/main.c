...
LRESULT CALLBACK WndProc(HWND hWnd,UINT message,WPARAM wParam,LPARAM lParam)
{
    ...
    static bool vis_edit=true,vis_page=true;
    long i,page;
...
//评分
    ...
    switch(message)
    {
        case WM_CREATE:
            ...
            hLabCheckMovie=CreateWindow(
                TEXT("static"),TEXT("修改电影"),
                WS_CHILD | WS_VISIBLE | WS_BORDER | SS_CENTER | SS_CENTERIMAGE,
                360,5,100,30,
            ...
            SendMessage(hLabCheckMovie,WM_SETFONT,(WPARAM)hFont,NULL);
            SendMessage(hEditCheckMovie,WM_SETFONT,(WPARAM)hFontTitle,NULL);
        ...
        case WM_COMMAND:
            ...
            switch (wmId)
            {
                ...
                GetWindowText(hEditIntroduce,szPassage,1000);    //name address
                    GetWindowText(hEditMovieName,szTextBuf,100);
                ...
                case 44:
                    ...
                    if (vis_page)
                    {
                        ...
                        if (page<=total_movie)
                        {
                            ...
                            //edit框因为未输入前执行一次，所以要取消这个的影响
                            if (movie[pos_user].UserNumber==0) movie[pos_movie].OverallMark=movie[pos_movie].ProfessorMark;
